const templateSavingsCalculator = document.createElement('template');
templateSavingsCalculator.innerHTML = `
  <style>
    :host {
      --cem: 18px;
...
window.customElements.define('savings-calculator', SavingsCalculator);
